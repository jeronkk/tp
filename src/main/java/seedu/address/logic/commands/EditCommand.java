...
public class EditCommand extends Command {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        TuitionTime updatedTuitionTime = editPersonDescriptor.getTuitionTime().orElse(personToEdit.getTuitionTime());
        Set<Tag> updatedTags = editPersonDescriptor.getTags().orElse(personToEdit.getTags());

        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedTuitionTime, updatedTags);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public EditPersonDescriptor(EditPersonDescriptor toCopy) {
            ...
            setTuitionTime(toCopy.tuitionTime);
            setTags(toCopy.tags);
        }
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, email, address, tuitionTime, tags);
        }
        ...
        public boolean equals(Object other) {
            ...
            return Objects.equals(name, otherEditPersonDescriptor.name)
                    ...
                    && Objects.equals(tuitionTime, otherEditPersonDescriptor.tuitionTime)
